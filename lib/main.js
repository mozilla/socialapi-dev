  ...
  injectController = function(doc, topic, data) {
    try {
      ...
      if (sbrowser && sbrowser.contentDocument == doc) {
        ...
        service.attachToWindow(doc.defaultView, createWindow);
      }
    } catch(e) {
...
function attachLikeButton(window, service) {
